...
export const ledgerEn = {
  ...
  reversal: {
    ...
    notReversibleHint: 'Cannot reverse: already reversed, or the entry has a source document.',
  ...
  manual: {
    ...
    notBalancedHint: 'Entries must balance (debits = credits) before posting',
  ...
  periods: {
    ...
    closeHint: 'Pick a fiscal year and period to close',
    reopenPeriod: 'Reopen period',
    reopenHint: 'Pick a fiscal year and period to reopen',
    ...
    closeYearHint: 'Pick a fiscal year to close — this closes every period in the year',
...
export const ledgerZh: typeof ledgerEn = {
  ...
  reversal: {
    ...
    notReversibleHint: '已沖正或該分錄有來源單據,無法沖正。',
    reversalDate: '沖正日期',
    reverse: '沖正分錄',
  ...
  periods: {
    ...
    periodMonth: '期間(月份)',
    closePeriod: '關閉期間',
    closeHint: '請選擇要關閉的會計年度與期間',
    reopenPeriod: '重開期間',
    reopenHint: '請選擇要重開的會計年度與期間',
    ...
    closeYearHint: '請選擇要結帳的會計年度 —— 將鎖定該年度所有期間',
