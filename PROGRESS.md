...
## 已完成
- [2026-07-01] 📝 **修正 README ADR 索引**:兩份 README(`README.md:255`、`README.en.md:361`)的「文件索引」表格把 `docs/adr/` 寫成「ADR 0001–0009」,但實際列到 `0010-journal-entry-reversal`(分錄沖正)。改為「0001–0010」——即上一則 Phase 3 條目末尾記下、留待處理的既有小落差。純文件、獨立小 PR。
