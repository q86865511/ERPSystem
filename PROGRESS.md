...
## 進行中
- (待指示)Phase 3(訂單到收款)與 Phase 4(製造)皆完成,「買→做→賣」最低可展示里程碑達成。下一棒 Phase 5 報表與期間結(資產負債表/損益表、TB 日期篩選、soft-close、對帳健康檢查 UI 一頁),或 Phase 6 打磨。計畫見 `~/.claude/plans/pm-erp-enchanted-aurora.md`。
